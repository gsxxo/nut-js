...
const libnut_screen_action_class_1 = __importDefault(require("./libnut-screen-action.class"));
...
describe("libnut screen action", () => {
    describe("screen data", () => {
        it("should reject when no screenshot data is available", async () => {
            // GIVEN
            const SUT = new libnut_screen_action_class_1.default();
            // WHEN
...
//# sourceMappingURL=libnut-screen-action.class.spec.js.map