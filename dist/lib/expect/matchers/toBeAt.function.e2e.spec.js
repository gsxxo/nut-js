...
describe(".toBeAt", () => {
    ...
    it("should succeed when cursor is at right position.", async () => {
        const result = await toBeAt_function_1.toBeAt(index_1.mouse, targetPoint);
        expect(result.pass).toBeTruthy();
    });
    it("should fail when cursor is at wrong position.", async () => {
        const result = await toBeAt_function_1.toBeAt(index_1.mouse, new point_class_1.Point(10, 10));
