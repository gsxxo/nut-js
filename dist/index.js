...
const vision_adapter_class_1 = require("./lib/adapter/vision.adapter.class");
...
const screenActions = new vision_adapter_class_1.VisionAdapter();
...
exports.mouse = mouse;
const screen = new screen_class_1.Screen(screenActions);
exports.screen = screen;
const assert = new assert_class_1.Assert(screen);
