...
const libnut_mouse_action_class_1 = __importDefault(require("./libnut-mouse-action.class"));
...
describe("libnut mouse action", () => {
    describe("leftClick", () => {
        it("should forward leftClick call to libnut", () => {
            // GIVEN
            const SUT = new libnut_mouse_action_class_1.default();
            // WHEN
            SUT.leftClick();
            // THEN
...
//# sourceMappingURL=libnut-mouse-action.class.spec.js.map